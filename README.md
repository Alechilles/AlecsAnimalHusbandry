...
<H2>New in v3.1.0</H2>
<p>Animals now support adult aging and new livestock care and production traits. With Tamework 4.1.0, the command panel lists owned companions automatically, keeps selections per flute, and shares groups across compatible flutes. Updated server presets include Hardcore rules. Both flutes use a 0.25-second command cooldown, and critical needs reminders alternate every five seconds. Update Animal Husbandry and Tamework together.</p>
...
<H2>Required:</H2>
<ul>
<li><a href="https://www.curseforge.com/hytale/mods/alecs-tamework">Alec's Tamework!</a> (4.1.0 or later in the 4.x series)</li>
</ul>
<H2>Recommended:</H2>
<ul>
...
Companion icon mappings live in `Server/Tamework/DynamicIcons/` and are shared by capture items and both command panels. These assets require the Tamework 4.1.0 or later in the 4.x series; update both mods together.
