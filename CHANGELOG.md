...
### Added
- Added Animal Husbandry-owned Frost Dragon avatar-flight model assets for Tamework dragon flight, including copied flight animations and a shoulder-mounted `MountAnchor` node for rider visuals.
